...
public class TFM_AdminList
{
    ...
    private static final Set<UUID> horseofdeathUUIDs;
    ...
    static
    {
        ...
        horseofdeathUUIDs = new HashSet<UUID>();
        seniorConsoleAliases = new HashSet<String>();
        superIps = new HashSet<String>();
    }
    
    public static boolean isHorseOfDeath(Player player)
    {   
        return false;    
    }
    ...
    public static Set<UUID> getHorseOfDeathUUIDs()
    {
        return Collections.unmodifiableSet(horseofdeathUUIDs);
    }
    ...
    public static void updateIndexLists()
    {
        ...
        for (TFM_Admin admin : adminList.values())
        {
            ...
            if (admin.isHorseOfDeath())
            {   
                horseofdeathUUIDs.add(uuid);
    ...
    private static void parseOldConfig(TFM_Config config)
    {
        ...
        for (String admin : config.getConfigurationSection("superadmins").getKeys(false))
        {
            ...
            config.set("admins." + uuid + ".is_horse_of_death", section.getBoolean(admin + "is_horse_of_death"));
    ...
    public static void save()
    {
        ...
        while (it.hasNext())
        {
            ...
            config.set("admins." + uuid + ".is_horse_of_death", superadmin.isHorseOfDeath());
    ...
    public static boolean isTelnetAdmin(CommandSender sender, boolean verifySuperadmin)
    {
        ...
        public static boolean isHorseOfDeath(CommandSender sender)
        {
            return isHorseOfDeath(sender, false);
        }
        
        public static boolean isHorseOfDeath(CommandSender sender, boolean verifySuperadmin)
    {
        if (verifySuperadmin)
        {
            if (!isSuperAdmin(sender))
