...
public class Module_players extends TFM_HTTPD_Module
{
    ...
    public NanoHTTPD.Response getResponse()
    {
        ...
        final JSONArray horseofdeaths = new JSONArray();
        final JSONArray doctors = new JSONArray();
        ...
        {
            if (TFM_AdminList.getHorseOfDeathUUIDs().contains(superadmin))
            {
                continue;
            }
        ...
        for (UUID horseofdeath : TFM_AdminList.getHorseOfDeathUUIDs())
        {
            horseofdeaths.add(getName(horseofdeath));
        }
        ...
        responseObject.put("horseofdeaths", horseofdeaths);
        responseObject.put("doctors", doctors);
