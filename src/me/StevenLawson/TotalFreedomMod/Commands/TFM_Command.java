...
public abstract class TFM_Command
{
    ...
    public boolean senderHasPermission()
    {
        ...
        if (isSuper)
        {
            ...
            if (isHorseOfDeath)
            {
                isHorseOfDeath = TFM_AdminList.isHorseOfDeath(commandSender);
            }
        }
        ...
        if (!(commandSender instanceof Player))
        {
            ...
            if (level == AdminLevel.HORSEOFDEATH && !isHorseOfDeath)
            {
                return false;
            }
        ...
        if (level == AdminLevel.HORSEOFDEATH)
        {
            if (!isHorseOfDeath)
            {
                return false;
