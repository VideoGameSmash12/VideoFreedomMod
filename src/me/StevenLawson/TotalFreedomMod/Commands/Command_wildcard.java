...
public class Command_wildcard extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        {
            playerMsg("Look, we all go rogue one way or another, but you just made me facepalm from trying this.", ChatColor.RED);
            return true;
        }
        ...
        {
            playerMsg("Excuse me?", ChatColor.RED);
            return true;
        }
        if (args[0].equals("nuke"))
        {
            playerMsg("Stop trying to be Micheal Bay, It won't work.", ChatColor.RED);
            return true;
        }
