...
public class Command_gtfo extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.bcastMsg(player.getName() + " has been obliterated!", ChatColor.RED);
        ...
        TFM_Util.bcastMsg(String.format("Banning: %s, IP: %s. " + "Reason: " + ChatColor.YELLOW + reason + "", player.getName(), ip), ChatColor.RED);
        ...
        // kick Player:
        player.kickPlayer(ChatColor.RED + "Get out!" + (reason != null ? ("\nReason: " + ChatColor.YELLOW + reason) : ""));
