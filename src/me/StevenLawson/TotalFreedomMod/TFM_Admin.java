...
public class TFM_Admin
{
    ...
    private final boolean isHorseOfDeath;
    private final List<String> consoleAliases;
    private final List<String> ips;
    private Date lastLogin;
    private boolean isActivated;

    public TFM_Admin(UUID uuid, String lastLoginName, Date lastLogin, String loginMessage, boolean isSeniorAdmin, boolean isTelnetAdmin, boolean isHorseOfDeath, boolean isActivated)
    {
        this.uuid = uuid;
        ...
        this.isHorseOfDeath = isHorseOfDeath;
    ...
    public TFM_Admin(UUID uuid, ConfigurationSection section)
    {
        ...
        this.isHorseOfDeath = section.getBoolean("is_horse_of_death", false);
    ...
    public String toString()
    {
        ...
        output.append("- Is Horse Of Death: ").append(isHorseOfDeath).append("\n");
    ...
    public boolean isHorseOfDeath()
    {
        return isHorseOfDeath;
    }
