...
public class TotalFreedomMod extends JavaPlugin
{
    ...
    //
    public static final String MSG_NO_PERMS = ChatColor.YELLOW + "Sorry, but you can't do this command, as you don't have permission for it.";
    public static final String MSG_WTF_MAN = ChatColor.RED + "Dude, What the fudge are you doing!?";
    public static final String YOU_ARE_OP = ChatColor.YELLOW + "You have been OP'd!";
    public static final String YOU_ARE_NOT_OP = ChatColor.YELLOW + "You've been unop'd, sadly.";
    public static final String CAKE_LYRICS = "But there's no sense crying over every mistake. You just keep on trying till you run out of cake. Haha, I rhymed!";
    public static final String NOT_FROM_CONSOLE = "Can't use this in the console, buddy.";
    public static final String PLAYER_NOT_FOUND = ChatColor.RED + "We couldn't find the target player, sadly.";
    //
